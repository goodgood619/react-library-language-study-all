...
const FreeSampleSvg = (props : any) => {

    return (
<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
	 width="472px" height="392px" viewBox="0 0 472 392" enable-background="new 0 0 472 392" onClick = {(e : any)=> props.poshandle(e)}>
<g id="Layer_3">
